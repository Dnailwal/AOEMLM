...
1. The training dataset for the model is named as:
 ...
 3. The dataset named as:
		F107 test_set.csv 
			is for the verticle profile of the green line with F10.7 
				This file includes a part of WINDII data from 2001 to 2003.

 4. The dataset named as:
		Test_profile_dataset.csv 
			includes all WINDII measured verticle profile data. 
				This file includes a part of WINDII data from 2001 to 2003.
 ...
 6. The dataset named as:
		GLOW_WINDII_daily_averaged_VER_2001_2003.csv
			includes the daily average volume emission rate calculated using the GLOW and AOEMLM models.
 ...
 8. The dataset named as:
		MISE_GLOW_AOEMLM_Intensity_2024.csv
			includes the green line (557.7 nm) intensity measured by the Photometer and 
				The integrated green line emission intensity was calculated using the AOEMLM and GLOW models.

 9. The results of the manuscript can be regenerated using the Python files named:
		AOEMLM_python_file.ipynb 
			and 
				Verticle_profiles_and_annual_average_VER.ipynb
